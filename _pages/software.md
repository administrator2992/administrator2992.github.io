...
- [The template](https://github.com/jayrobwilliams/JobMarket) I use for my academic job market materials
    ...
    - Generate summary statistics from portofolio evaluations and integrate into statements
    - Combine multiple portofolio evaluations into a single portfolio document
...
- [Scripts](https://github.com/jayrobwilliams/Portofolio) that I use to save time on various portofolio-related tasks like grading
